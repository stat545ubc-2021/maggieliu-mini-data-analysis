...
**Exercise 1:** The dataset is almost entire quantitative, with each
quantity describing a feature of an image of nuclei present in fine
needle aspiration biopsies of breast masses. Hence, looking at the
distribution of these features will give us a better idea of which might
be random, and which might have higher predictive power.
